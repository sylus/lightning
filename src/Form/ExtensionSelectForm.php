...
class ExtensionSelectForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, array &$install_state = NULL) {
    ...
    if (!empty($this->extender->getLightningExtensions())) {
      $disabled = TRUE;
      $default_value = $this->extender->getLightningExtensions();
      $form['set_by_extender'] = [
        '#markup' => '<p>Lightning Extensions have been set by the lightning.extend.yml file in your sites directory.</p>',
      ];
    }
